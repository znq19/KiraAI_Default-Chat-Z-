...
class DebouncePlugin(BasePlugin):
    ...
    def __init__(self, ctx, cfg: dict):
        ...
        _enhance_cfg = {
            ...
            "bot_speech_block_session": _sec("section_detect", "bot_speech_block_session", True),
            ...
            "extra_max_duration": _sec("section_thresholds", "extra_max_duration", 300),
    ...
    async def initialize(self):
        ...
        #      注意：本插件 plugin_id 为 `default-chat（z）`，故必须精确匹配
        #      "default-chat"，绝不能用子串匹配，否则会把自己停用。
        ...
        try:
            ...
            if _pm is not None:
                ...
                # ---- default-chat：先迁移唤醒词，再停用（精确匹配，避免误伤自身）----
